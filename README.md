...
object **Pedro** {
 ...
 val primarySkillset = "Comunicação, empatia, cooperação, liderança, sempre em busca de resultados."
 val languages = listOf("Java", "C#", "Python", "SQL") 
}
```
...
<code><img height="30" src="https://img.shields.io/badge/IntelliJ_IDEA-000000.svg?style=for-the-badge&logo=intellij-idea&logoColor=white"></code>
